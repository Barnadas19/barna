...
btn_plus = tk.Button(root, text="+", command=lambda:add_to_calculation("+"), width=5, font=("Areal",14)) 
...
btn_multiplication = tk.Button(root, text="X", command=lambda:add_to_calculation("*"), width=5, font=("Areal",14)) 

btn_multiplication.grid(row=4, column=4) 

btn_division = tk.Button(root, text="/", command=lambda:add_to_calculation("/"), width=5, font=("Areal",14)) 

btn_division.grid(row=5, column=4) 

btn_clear = tk.Button(root, text="C", command=clear_field, width=5, font=("Areal",14)) 

btn_clear.grid(row=5, column=1) 

btn_equals = tk.Button(root, text="=", command=evaluate_calculation, width=5, font=("Areal",14)) 
